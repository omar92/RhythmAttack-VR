    ...
    public class AboutMPTK : PopupWindowContent
    {
        ...
        public override void OnGUI(Rect rect)
        {
            try
            {
                ...
                EditorGUI.LabelField(new Rect(xCol2, yStart, colWidth, colHeight), MidiPlayerSetupWindow.version);

                EditorGUI.LabelField(new Rect(xCol1, yStart += ySpace, colWidth, colHeight), "Release:");
                EditorGUI.LabelField(new Rect(xCol2, yStart, colWidth, colHeight), MidiPlayerSetupWindow.releaseDate);
                ...
                {
                    //Application.OpenURL(MidiPlayerToolsEdit.UnitySite);
